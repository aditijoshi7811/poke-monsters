  ...
  <div class="pokemon-images">
    <div class="image-container">
      ...
      <img 
        ...
        loading="lazy"
      />
      <p v-else class="no-image" role="status">No front image available for {{ capitalize(pokemon.name) }}</p>
    </div>
    ...
    <div class="image-container">
      ...
      <img 
        ...
        loading="lazy"
      />
      <p v-else class="no-image" role="status">No back image available for {{ capitalize(pokemon.name) }}</p>
    </div>
  </div>
</template>
